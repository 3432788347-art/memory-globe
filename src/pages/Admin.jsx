  ...
  return (
    <div className="min-h-screen bg-slate-900 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        {isFormOpen && (
          <form onSubmit={handleSubmit} className="bg-slate-800 p-6 rounded-xl border border-slate-700 mb-6">
            ...
            <div className="mb-4">
              <div className="flex justify-between items-center mb-2">
                ...
                <button type="button" onClick={addPhoto} className="text-purple-400 text-sm">+ 添加照片</button>
              </div>
            ...
            <div className="flex gap-3">
              <button type="submit" className="bg-purple-600 hover:bg-purple-700 text-white px-6 py-2 rounded-lg font-bold">
                保存
              </button>
